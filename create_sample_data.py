    ...
    try:
        ...
        farmers_data = [
            {
                ...
                "profile": {
                    ...
                    "farm_type": FarmType.CROP_FARMING,
                    "farm_size": "5 acres",
            ...
            },
            {
                ...
                "profile": {
                    ...
                    "farm_type": FarmType.MIXED_FARMING,
                    "farm_size": "12 acres",
            ...
            },
            {
                ...
                "profile": {
                    ...
                    "farm_type": FarmType.LIVESTOCK_FARMING,
                    "farm_size": "20 acres",
            ...
            },
            {
                ...
                "profile": {
                    ...
                    "farm_type": FarmType.POULTRY_FARMING,
                    "farm_size": "3 acres",
        ...
        for farmer_data in farmers_data:
            ...
            profile = FarmerProfile(
                ...
                years_of_experience=farmer_data["profile"]["years_of_experience"],
                is_verified=True
            )
            db.add(profile)
            farmers.append(user)
        ...
        for consumer_data in consumers_data:
            ...
            profile = ConsumerProfile(
                user_id=user.id,
                full_name=consumer_data["profile"]["full_name"],
                location=consumer_data["profile"]["location"]
            )
            db.add(profile)
        ...
        for consumer_data in consumers_data:
            ...
            print(f"   Name: {consumer_data['profile']['full_name']}")
            print()
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Create a delivery issue for the DELIVERY_ISSUE order
        issue_order = [o for o in orders if o.status == OrderStatus.DELIVERY_ISSUE][0]
        issue = OrderIssue(
            order_id=issue_order.id,
            consumer_id=issue_order.consumer_id,
            issue_description="Package left at gate, items missing, never received, etc.",
        ...
        db.commit()
        print(f"Created {len(orders)} orders with timeline entries and 1 delivery issue")
        ...
        db.commit()
        print(f"Created {len(delivered_orders)} reviews")
